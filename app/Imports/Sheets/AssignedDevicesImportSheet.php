            ...
            foreach ($rows as $row) {
                ...
                if (! empty($employeeEmail) && $employeeEmail !== 'n/a') {
                    ...
                    if ($employee->wasRecentlyCreated === false) {
                        if (! empty($row['empleado_asignado']) && $row['empleado_asignado'] !== 'N/A') {
                            $employee->name = (string) $row['empleado_asignado'];
                        }
                        if (! empty($row['departamento']) && $row['departamento'] !== 'N/A') {
                            $employee->department = (string) $row['departamento'];
                        }
                        if (! empty($row['puesto']) && $row['puesto'] !== 'N/A') {
                            $employee->position = (string) $row['puesto'];
                        }
