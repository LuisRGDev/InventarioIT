<div {{ $attributes->merge(['class' => 'flex items-center gap-3']) }}>
    <div class="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-middleby-900 via-middleby-800 to-middleby-600 shadow-md border border-middleby-400/30 text-white overflow-hidden group">
        {{-- Modern IT / Processor & Shield Emblem --}}
    ...
    <div class="flex flex-col leading-none">
        <div class="flex items-center gap-1">
            <span class="text-xl font-extrabold tracking-tight text-middleby-900 font-sans">IT</span>
            <span class="text-xl font-medium tracking-tight text-middleby-700 font-sans ml-0.5">Inventario</span>
            <span class="w-1.5 h-1.5 rounded-full bg-amber-500 inline-block animate-pulse ml-1" title="Sistema Online"></span>
        </div>
        <span class="text-[10px] font-semibold text-slate-400 tracking-widest uppercase mt-0.5">Control de Infraestructura</span>
    </div>
</div>
