                                ...
                                <tr class="hover:bg-gray-50 transition group">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                                            <a href="{{ route('office-extensions.edit', $ext) }}" class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-indigo-600 bg-white rounded-lg hover:bg-indigo-50 border border-transparent hover:border-indigo-100 transition shadow-sm" title="Editar" aria-label="Editar">
                                            ...
                                            <form action="{{ route('office-extensions.destroy', $ext) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar esta extensión? Se borrará su historial de forma permanente.');" class="inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-red-600 bg-white rounded-lg hover:bg-red-50 border border-transparent hover:border-red-100 transition shadow-sm" title="Eliminar" aria-label="Eliminar">
