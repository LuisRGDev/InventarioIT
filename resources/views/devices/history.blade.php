    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">{{ $device->brand }} {{ $device->model }}  <span class="font-mono">{{ $device->serial_number }}</span></p>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Registrado por</th>
                            ...
                            @forelse($assignments as $assignment)
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span class="text-gray-300 text-xs"></span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
                                        @if($returnCond)
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600">
                                        {{ $assignment->assignedBy?->name ?? '' }}
                                    </td>
                                    <td class="px-6 py-4">
                                        @if($assignment->returned_at)
