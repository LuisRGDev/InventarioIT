                ...
                <form method="POST" action="{{ route('devices.update', $device) }}" class="p-6 space-y-8"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            {{-- Identificador de BL y Clave de BL: solo Admin TI puede verlos/editarlos --}}
                            @role('Admin TI')
                                <div x-show="isComputer" style="display: none;">
                                    ...
                                    <x-text-input id="bitlocker_identifier" name="bitlocker_identifier" type="text" class="mt-1 block w-full font-mono"
                                                  ...
                                                  value="{{ old('bitlocker_identifier', $device->bitlocker_identifier) }}" placeholder="Ej. 70F73ABC..."
                                ...
                                <div x-show="isComputer" style="display: none;">
                                    ...
                                    <x-text-input id="bitlocker_key" name="bitlocker_key" type="text" class="mt-1 block w-full font-mono"
                                                  x-bind:disabled="!isComputer"
                                                  value="{{ old('bitlocker_key', $device->bitlocker_key) }}" placeholder="Ej. 483120-..."
