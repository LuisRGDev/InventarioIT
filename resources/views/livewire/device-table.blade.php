        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-wrap gap-3 items-end">
                <div class="flex-1 min-w-[200px]">
                    <label for="device-search" class="block text-xs font-medium text-gray-500 mb-1">Buscar Equipo</label>
                    <div class="relative">
                        ...
                        <input type="text" id="device-search" wire:model.live.debounce.300ms="search" placeholder="Serial, marca, modelo..." class="w-full pl-9 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                    </div>
                </div>

                <div class="min-w-[180px]" x-data="{ open: false }" @click.outside="open = false">
                    <label for="device-category-filter" class="block text-xs font-medium text-gray-500 mb-1">Categoría</label>
                    <div class="relative">
                        <button type="button" id="device-category-filter" @click="open = !open" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm text-left bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400 flex items-center justify-between">
                            <span>
                ...
                <div class="min-w-[150px]">
                    <label for="device-model-filter" class="block text-xs font-medium text-gray-500 mb-1">Modelo</label>
                    <select id="device-model-filter" wire:model.live="model_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                ...
                <div class="min-w-[140px]">
                    <label for="device-status-filter" class="block text-xs font-medium text-gray-500 mb-1">Estatus</label>
                    <select id="device-status-filter" wire:model.live="status" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                        <option value="">Todos</option>
                ...
                <div class="min-w-[140px]">
                    <label for="device-condition-filter" class="block text-xs font-medium text-gray-500 mb-1">Condición</label>
                    <select id="device-condition-filter" wire:model.live="condition" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
            ...
            <div class="flex flex-wrap gap-3 items-end">
                <div class="min-w-[150px]">
                    <label for="device-date-from" class="block text-xs font-medium text-gray-500 mb-1">Registrado Desde</label>
                    <input type="date" id="device-date-from" wire:model.live="date_from" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                </div>
                <div class="min-w-[150px]">
                    <label for="device-date-to" class="block text-xs font-medium text-gray-500 mb-1">Registrado Hasta</label>
                    <input type="date" id="device-date-to" wire:model.live="date_to" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('devices.show', $device) }}" class="p-2.5 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition" title="Ver detalles">
